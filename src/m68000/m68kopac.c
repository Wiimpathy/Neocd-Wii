...
void m68k_op_1111(void)
{
	...
	/*** Reuse FABF as end of loading (neogeo_end_upload) ***/
	case 0xfabf: neogeo_end_upload();break;
	/*** img_display is corrected in cdrom_load_files ***/
	case 0xfac0: img_display=0; cdrom_load_files(); break;
	case 0xfac1: neogeo_upload(); break;
		
	/*** neogeo_prio_switch no longer required
	case 0xfac2: neogeo_prio_switch(); break;
	***/
	
	case 0xfac3: neogeo_cdda_control(); break;
	case 0xfac4: neogeo_exit_cdplayer(); break;
        case 0xfac5: neogeo_progress_show(); break;
	case 0xfac6: neogeo_start_upload(); break;
	case 0xfac7: neogeo_ipl(); break;
	case 0xfac8: neogeo_ipl_end(); break;
	case 0xface: neogeo_trace(); break;
